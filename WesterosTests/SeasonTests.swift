...
class SeasonTests: XCTestCase {
    ...
    func testSeasonAddEpisodes() {
        ...
        let episode1 = Episode(name: "Winter Is Coming", overview: "Jon Arryn, the Hand of the King, is dead. King Robert Baratheon plans to ask his oldest friend, Eddard Stark, to take Jon's place. Across the sea, Viserys Targaryen plans to wed his sister to a nomadic warlord in exchange for an army.", airDate: Date.fromString(date: "2011/04/17")!, poster:#imageLiteral(resourceName: "episode1x01.jpg"), season: season)
        
        let episode2 = Episode(name: "The Kingsroad", overview: "While Bran recovers from his fall, Ned takes only his daughters to Kings Landing. Jon Snow goes with his uncle Benjen to The Wall. Tyrion joins them.", airDate: Date.fromString(date: "2011/04/24")!, poster:#imageLiteral(resourceName: "episode1x02.jpg"), season: season)
